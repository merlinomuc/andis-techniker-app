...
app.get('/api/health',(_req,res)=>res.json({ok:true,configured:Boolean(process.env.OPENAI_API_KEY),version:'2.0',visionModel:process.env.OPENAI_VISION_MODEL||'gpt-4.1-mini',researchModel:process.env.OPENAI_RESEARCH_MODEL||'gpt-5-mini',architecture:'split-pipeline'}));
...
app.listen(port,()=>console.log(`Andis Techniker-App v2.0 auf Port ${port}`));
