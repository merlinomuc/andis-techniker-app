...
app.get('/api/health',(_req,res)=>res.json({ok:true,configured:Boolean(process.env.OPENAI_API_KEY),version:'3.2',visionModel:process.env.OPENAI_VISION_MODEL||'gpt-4.1-mini',researchModel:process.env.OPENAI_RESEARCH_MODEL||'gpt-5-mini',architecture:'simple-ux-with-vision-and-research-retry'}));
...
app.listen(port,()=>console.log(`Andis Techniker-App v3.2 auf Port ${port}`));
